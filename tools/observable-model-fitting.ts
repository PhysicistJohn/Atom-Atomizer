...
import type { StudentTLikelihoodComponent } from '../packages/analysis/src/bayesian-predictive.js';
import { OBSERVABLE_LIKELIHOOD_COMPONENT_DECOMPOSITION_POLICY } from '../packages/analysis/src/observable-classifier-model.js';

export { OBSERVABLE_LIKELIHOOD_COMPONENT_DECOMPOSITION_POLICY } from '../packages/analysis/src/observable-classifier-model.js';
