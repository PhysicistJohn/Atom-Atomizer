...
import { DETECTED_POWER_ACQUISITION_QUALIFICATION } from '../packages/analysis/src/observable-features.js';
import {
...
const OUTPUT = resolve('packages/analysis/src/models/bayesian-observable.generated.ts');
const MANIFEST_OUTPUT = resolve('packages/analysis/src/models/bayesian-observable.manifest.generated.ts');
