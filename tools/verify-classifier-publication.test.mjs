...
const MODEL_PATH = 'packages/analysis/src/models/bayesian-observable.generated.ts';
const MANIFEST_PATH = 'packages/analysis/src/models/bayesian-observable.manifest.generated.ts';
