...
Status: active execution baseline, instrument API v1, SignalLab measurement bridge v2, TinySA protocol v3, trio composition v5, 2026-07-27
Companion: [PLAN.md](./PLAN.md)

Trio authority: [contracts/trio-composition-v5.json](./contracts/trio-composition-v5.json)
...
| SignalLab measurements | `Atom-SignalLab` measurement bridge v2 | `signal-lab` driver | Active bounded in-process edge; strict profile governance, scalar projections, and digitally qualified or explicitly derived/impaired I/Q; never USB/firmware/RF evidence |
...
durable Atomizer↔Flasher handoff lease: composition v5 requires a local-human
