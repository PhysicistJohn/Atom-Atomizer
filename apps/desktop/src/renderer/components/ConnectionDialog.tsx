import { Cable, Check, Cpu, FlaskConical, LoaderCircle, Power, RefreshCw, Usb, X } from 'lucide-react';
import type {
...
export function ConnectionDialog({ candidates, selectedId, connectedId, busy, error, failures, preference, connectionCleanup, onChoose, onRefresh, onDisconnect, onMakeDefault, onClose }: {
