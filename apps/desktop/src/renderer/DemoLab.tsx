...
export function DemoLab() {
  ...
  return <main className="demo-lab">
    <header><div className="demo-orbit"><i/><i/><i/><b/></div><div><small>TINYSA ATOMIZER</small><strong>Signal Lab</strong></div><span><i/>ATTACHED</span></header>
    <section className="demo-copy"><span>SYNTHESIZED RF</span><h1>Choose a signal</h1><p>The next Atomizer sweep is generated by the byte-level ZS407 simulator.</p></section>
    ...
    <footer><span>{status?.active ? 'ZS407 DEMO ONLINE' : 'DEMO STANDBY'}</span><span>88—108 MHz canvas</span></footer>
  </main>;
}
