...
const sweep: Sweep = {
  ...
  identity: { model: 'tinySA Ultra+ ZS407', hardwareVersion: 'V0.5.4 + ZS407', firmwareVersion: 'sim', firmwareSourceCommit: FIRMWARE_SOURCE_COMMIT, port: { id: 'sim', path: 'simulator://zs407', usbMatch: 'exact-zs407-cdc' }, simulated: true, usbIdentityVerified: true },
};
