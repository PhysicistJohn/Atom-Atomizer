...
The cross-repository source of truth is [trio-composition-v1.json](../contracts/trio-composition-v1.json). Any activation of a SignalLab stimulus sink requires a new coordinated trio contract version.
