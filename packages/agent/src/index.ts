...
export const agentControlBindings: readonly AgentControlBinding[] = [
  ...
  { pattern: /^classification\.auto-select$/, preferredTool: 'computer_action', risk: 'operate', projection: 'ui-only', guarantee: 'Clears sticky manual targeting and resumes strongest-current peak selection over the complete visible spectrum.' },
