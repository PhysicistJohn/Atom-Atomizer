...
export const agentControlBindings: readonly AgentControlBinding[] = [
  ...
  { pattern: /^classification\.auto-select$/, preferredTool: 'computer_action', risk: 'operate', projection: 'ui-only', guarantee: 'Clears sticky manual targeting and ranks the complete visible spectrum by exact current-source-sweep integrated excess power. Rank 0 must reach exact eight-sweep runtime admission; a ready lower-ranked target is never substituted.' },
