...
export const agentControlBindings: readonly AgentControlBinding[] = [
  ...
  { pattern: /^trace\.[1-4]\.(mode|average-count)$/, preferredTool: 'configure_trace', risk: 'operate', projection: 'host-derived', guarantee: 'Configures one of four host trace projections, including an explicit Off state.' },
